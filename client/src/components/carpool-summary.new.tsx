...
export default function CarpoolSummaryNew({ partyGroupId, onRequestSpot, onBackToEvents }: CarpoolSummaryProps) {
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {carpoolRequests[carpool.id] 
                            ...
                            : `${carpool.returnSpacesAvailable} spaces available`
                          }
                        </p>
                        ...
                        <div className="mt-3 text-sm text-gray-600 space-y-1">
                          <div className="flex items-center gap-2">
                            <Clock className="h-3 w-3 text-gray-400" />
                            <span>Departure time: {carpool.returnTime || "Not specified"}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <MapPin className="h-3 w-3 text-gray-400" />
