  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab}>
        ...
        {/* Map View Toggle and Enhanced MapBox Map */}
          ...
          <div className="flex items-center gap-2">
            ...
            {showMapView && (
              <span className="text-sm text-gray-600">
                View carpool locations and distances on map
              </span>
            )}
          </div>
        </div>

        {/* Enhanced MapBox Map View */}
        {showMapView && (
          <div className="mb-6">
            <MapboxMap
              ...
              eventLocation={
                partyGroup?.eventAddress && partyGroup?.eventPostcode
                  ? {
                      lat: 0, // Will be geocoded in the component
                      lng: 0,
              ...
              carpoolLocations={filteredCarpools
                .filter(carpool => carpool.carpoolCoordinates && carpool.carpoolCoordinates[0] !== 0 && carpool.carpoolCoordinates[1] !== 0)
                .map(carpool => ({
                  id: carpool.id,
                  lat: carpool.carpoolCoordinates[0],
                  lng: carpool.carpoolCoordinates[1],
                  parentName: carpool.parentName,
                  address: `${carpool.address}, ${carpool.city}`,
