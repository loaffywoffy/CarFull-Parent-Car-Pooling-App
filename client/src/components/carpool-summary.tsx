                            ...
                            <ul className="mt-1 text-gray-600">
                              {carpoolRequests[carpool.id].map(request => (
                                <li key={request.id} className="flex items-center gap-1">
                                  • {request.childName} ({request.childAge}y)
                                </li>
                              ))}
                            </ul>
                          </div>
                          ...
                          <div className="grid gap-6 py-4">
                            ...
                            <div>
                              ...
                              <div className="space-y-2 text-sm">
                                ...
                                <div className="flex items-center gap-2">
                                  <span className="font-medium w-20">Car Type:</span>
                                  ...
                                  {carpoolRequests[carpool.id].map(request => (
                                    <li key={request.id} className="text-sm flex gap-2">
                                      ...
                                      <span className="text-gray-500">
                                        ({request.childAge}y) - {request.address.substring(0, 20)}...
                                      </span>
                                    </li>
                                  ))}
                                </ul>
                          ...
                          <div className="grid gap-6 py-4">
                            ...
                            <div>
                              ...
                              <div className="space-y-2 text-sm">
                                ...
                                <div className="flex items-center gap-2">
                                  <span className="font-medium w-20">Location:</span>
                                  <span>{carpool.address ? `Pickup from ${carpool.parentName}'s house (${carpool.address})` : 'Location not specified'}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  <span className="font-medium w-20">Notes:</span>
                                  <span>{carpool.notes || "No additional notes"}</span>
